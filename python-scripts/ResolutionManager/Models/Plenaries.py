...
class Plenary(object):
    ...
    def formatted_plenary_date(self):
        ...
        return Templates.DATE_TEMPLATE.format(month=self.month, thurs=self.thursday_day, friday=self.friday_day,
                                              year=self.year)
    ...
    def plenary_folder_name(self):
        return Templates.PLENARY_FOLDER_TEMPLATE.format(year=self.year, month=self.month)
